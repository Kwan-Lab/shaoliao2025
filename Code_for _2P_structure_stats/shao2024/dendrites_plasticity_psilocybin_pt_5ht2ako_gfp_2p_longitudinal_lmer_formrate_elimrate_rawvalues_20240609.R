...
# 
# measures: formation and elimination rates
# 
# notes:
# run linear mixed effects models of spine formation rate and elimination rate (raw values)
# 
...
## load data table(s)
form.rate  <- read.csv(paste(data_dir, "gfp_2p_psilocybin_pt_5ht2ako_spine_formationrate_rawvalues_20240608.csv", sep = "/"), header = TRUE)
elim.rate  <- read.csv(paste(data_dir, "gfp_2p_psilocybin_pt_5ht2ako_spine_eliminationrate_rawvalues_20240608.csv", sep = "/"), header = TRUE)
