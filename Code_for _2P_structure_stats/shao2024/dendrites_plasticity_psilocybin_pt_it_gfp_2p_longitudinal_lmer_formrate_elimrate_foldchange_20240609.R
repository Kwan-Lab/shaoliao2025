...
# 
# measures: formation and elimination rates FOLD CHANGES
# 
# notes:
# run linear mixed effects models of spine formation rate and elimination rate
# 
# 20230221 $nks kwanlab @ cornell bme
...
## load data table(s)
form.rate  <- read.csv(paste(data_dir, "gfp_2P_psilocybin_pt_it_spine_formationrate_foldchange_20240610.csv", sep = "/"), header = TRUE)
elim.rate  <- read.csv(paste(data_dir, "gfp_2P_psilocybin_pt_it_spine_eliminationrate_foldchange_20240610.csv", sep = "/"), header = TRUE)
